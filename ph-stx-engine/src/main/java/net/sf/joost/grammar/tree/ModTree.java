...
/**
 * Objects of ModTree represent arithmetic mod nodes in the syntax tree of a
 * pattern or an STXPath expression.
 * 
 * @version $Revision: 1.1 $ $Date: 2004/09/29 05:59:51 $
 * @author Oliver Becker
 */
public final class ModTree extends AbstractTree
{
  public ModTree (final AbstractTree left, final AbstractTree right)
  {
